...
GETAPPS;
	...
	const READ_APP = <<<BIG_ICKY_JOIN
		SELECT ST.STU_TYPE_DESC, C.COL_NAME, DT.DEG_DESC, D.DEG_NAME, T.TERM_YEAR,
		SE.SEASON_DESC, PI.PERS_INFO_ID, PI.FIRST_NAME, PI.LAST_NAME, PI.PREF_FIRST_NAME,
...
BIG_ICKY_JOIN;
	...
	const GET_RACES = "SELECT RACE_DESC FROM RACE NATURAL JOIN APP_RACE WHERE PERS_INFO_ID = ?;";
	
	const GET_MILITARY_BRANCHES = "SELECT BRANCH_DESC FROM MILITARY_BRANCH NATURAL JOIN APP_MILITARY_BRANCH WHERE PERS_INFO_ID = ?;";
